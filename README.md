...
2. Fine Classification: Multi-class breed classification (48 breeds) using feature
   fusion from multiple CNN models
...
Fused Features (Fine)         ~99.1%               4-model feature fusion
...
Installation:
    pip install tensorflow keras numpy pandas matplotlib seaborn scikit-learn
                opencv-python scikit-image tqdm pillow
...
- labels.csv: CSV file with columns id and breed label (for coarse classification)
